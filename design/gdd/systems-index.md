...
| 10 | Exercise → Class Mapping | Core | Pre-MVP | **Designed (pending review)** 2026-06-01 — lean pass; closed lookup service (push→STRIKE/pull→CONTROL/leg→MOBILITY 1:1:1, no hybrid per #12 FR-1); #9 owns dominant streaming; categorical (no balance formula); 3 prereq ADRs (0007/0008/0003) all Accepted; Q1 autoload-vs-static boot-order open | [exercise-class-mapping.md](exercise-class-mapping.md) | 2, 7 |
