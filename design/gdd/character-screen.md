...
| **G-CS-7** | **ADR-0001 revision:#22 CanvasLayer 60 註冊**(Rule 34;同 #21 G-LM-1 先例)— 包 layer 號 + process_mode PAUSABLE +「P-07 preview 要求 <100」mechanism note(capture bound canonical:ADR-0001 L117+L132[G-IU-3 (g) erratum];code-side screen_effects.gd L363-364)+ **ADR-0001 L107 capture enumeration 明文更新「0/10/50」→「0/10/50/60」**(verifier 補)| ADR revision(CD 裁決 5)|
