...
│  ├─ BackBufferCopy  (captures layers 0/10/15*/50/60/61/62 into screen texture)  [#22 revision: +60; #23 revision: +61; #24 revision: +62; #25 revision: +15* CombatNumberLayer, *provisional/ratification-scope]
...
- **>100 = outside BackBufferCopy capture**: BackBufferCopy at layer 100 captures layers 0/10/15*/50/60/61/62 only (#22 revision added 60; #23 revision added 61; #24 revision added 62; #25 revision added 15* CombatNumberLayer — *provisional integer, Q-CV2 ratification scope; it rides the shake precisely because it is < 100) — content on **105/**110/111/120 is **immune to saturation (world −60% desaturation) and shader shake**. This is the mechanism behind #21 AC-75/AC-87 (loot burst stays fully saturated while the world desaturates; art bible「爆裝特效全飽和」), #24's `ErrorBannerLayer` (111) reading truthfully through world desaturation, and #25's `CombatOverlayLayer` (105) flashing at full contrast over a desaturated world (GDD R-11).
