# ScreenEffects — Story 008: autoload position 14, after ParticleSystemWrapper (12).
#
...
func test_screen_effects_is_position_14_after_particle_wrapper() -> void:
	...
	assert_eq(se_idx + 1, 14, "ScreenEffects must be at autoload position 14 (ADR-0008 ground truth)")
	assert_lt(psw_idx, se_idx, "ScreenEffects must boot AFTER ParticleSystemWrapper (pos 12)")
