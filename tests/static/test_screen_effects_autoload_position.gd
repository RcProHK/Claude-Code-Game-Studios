# ScreenEffects — Story 008: autoload position 16, after AvatarRenderer (14).
# (Shifted 14→15 by #10 Story 005: ExerciseClassMapping at pos 5; then 15→16 by #26 Story 001:
#  AvatarRenderer inserted at pos 14 — ADR-0008 v2 G-AR-1.)
#
...
func test_screen_effects_is_position_16_after_particle_wrapper() -> void:
	...
	assert_eq(se_idx + 1, 16, "ScreenEffects must be at autoload position 16 (ADR-0008 v2 ground truth)")
