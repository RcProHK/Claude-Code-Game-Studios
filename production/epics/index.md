...
| [Audio Manager](audio-manager/EPIC.md) | Foundation | #4 | audio-manager.md ✅ Approved 2026-06-02 (Pass 6) | **9 stories** (4 Complete local-verified, 005-009 Ready — 6 Logic, 3 Integration) | **In Progress 4/9** — 001 gateway / 002 bus+volume+F2 / 003 sfx pool+steal / 004 ducking F3 done 2026-06-02 (local GUT audio 33/33, full gate 236scr/0fail); NEXT 005 (BGM crossfade); 3 external gates story-level (006 情境A / 007 forwarding) 唔阻 epic |
