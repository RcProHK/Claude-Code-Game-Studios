...
Last Updated: 2026-06-11 (+ **#25 Combat Visual Feedback — 7th Presentation epic**;GDD+UX 雙 APPROVED 同日;PR-EPIC degraded-inline REALISTIC[單一 `CombatVisualFeedback` module 唔合併;baseline 14–18;G-CV-1 ADR-0001 兩-layer + G-CV-2 ADR-0008 = scaffold 前提;#26 anchor 非 MVP dep]) — prior: 2026-06-10 (+ **#26 Avatar Renderer + #29 Mirror Moment — coupled pair**;#26 = 第六亦最後 Presentation epic / #29 = Polish MVP-screenshot-only;兩 GDD APPROVED + ADR-0010 Accepted + 2 UX spec APPROVED 同日;PR-EPIC degraded inline REALISTIC[兩 epic 一系統一 module 唔合併 — ADR-0010 ownership seam;#26 baseline 16–20 / #29 baseline 14–18;coupled pair #26 先 implement;G-AR-3 ⇄ G-MM-3 preset 策略一齊決定;G-MM-4 cadence parity 從 #26 source 註冊]) — prior: #24 Login/Shell 2026-06-08; #22 Character Screen 2026-06-07
...
| Metric | Count |
|--------|-------|
| Total epics | 27 (16 Foundation+Core + 4 Feature + 6 Presentation + 1 Polish) |
| Ready (GDD Approved) | 26 |
