...
| [Audio Manager](audio-manager/EPIC.md) | Foundation | #4 | audio-manager.md ✅ Approved 2026-06-02 (Pass 6) | **9 stories** (8 Complete local-verified, 009 Ready — 6 Logic, 3 Integration) | **In Progress 8/9** — 001-008 done 2026-06-02 (gateway/bus/sfx/ducking/BGM/GSM/unlock/SUSPENDED; local GUT audio 60/60, full gate 240scr/0fail); NEXT 009 (BGM rotation + min-loop, Logic — last); story-level gates 情境A=EG-3(#15) / 007 forwarding=EG-1(#9)+EG-2(#20) 唔阻 epic |
