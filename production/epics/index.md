...
| [Audio Manager](audio-manager/EPIC.md) | Foundation | #4 | audio-manager.md ✅ Approved 2026-06-02 (Pass 6) | **9 stories** (5 Complete local-verified, 006-009 Ready — 6 Logic, 3 Integration) | **In Progress 5/9** — 001 gateway / 002 bus+vol+F2 / 003 sfx pool+steal / 004 ducking F3 / 005 BGM crossfade F1 done 2026-06-02 (local GUT audio 37/37, full gate 237scr/0fail); NEXT 006 (GSM music transition, Integration); 3 external gates story-level (006 情境A=EG-3 / 007 forwarding) 唔阻 epic |
