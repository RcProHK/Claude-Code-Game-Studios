...
| [Audio Manager](audio-manager/EPIC.md) | Foundation | #4 | audio-manager.md ✅ Approved 2026-06-02 (Pass 6) | **9 stories** (7 Complete local-verified, 008-009 Ready — 6 Logic, 3 Integration) | **In Progress 7/9** — 001-007 done 2026-06-02 (gateway/bus+vol/sfx pool/ducking/BGM crossfade/GSM transition/Safari unlock; local GUT audio 52/52, full gate 239scr/0fail); NEXT 008 (SUSPENDED multi-source, Integration); story-level gates 情境A=EG-3(#15) / 007 forwarding=EG-1(#9)+EG-2(#20) 唔阻 epic |
