...
| [Audio Manager](audio-manager/EPIC.md) | Foundation | #4 | audio-manager.md ✅ Approved 2026-06-02 (Pass 6) | **9 stories** (3 Complete local-verified, 004-009 Ready — 6 Logic, 3 Integration) | **In Progress 3/9** — 001 (gateway+CI lint+autoload pos 16) / 002 (bus+volume+Formula 2) / 003 (sfx pool+priority steal) done 2026-06-02 (local GUT 26/26, full gate 235scr/0fail); NEXT 004 (ducking); 3 external gates story-level (006 情境A / 007 forwarding) 唔阻 epic |
