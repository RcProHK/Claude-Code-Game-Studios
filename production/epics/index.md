...
| [Audio Manager](audio-manager/EPIC.md) | Foundation | #4 | audio-manager.md ✅ Approved 2026-06-02 (Pass 6) | **9 stories** (6 Complete local-verified, 007-009 Ready — 6 Logic, 3 Integration) | **In Progress 6/9** — 001 gateway / 002 bus+vol+F2 / 003 sfx pool+steal / 004 ducking F3 / 005 BGM crossfade F1 / 006 GSM music transition done 2026-06-02 (local GUT audio 44/44, full gate 238scr/0fail); NEXT 007 (Safari unlock, Integration); 情境A=EG-3(#15) / 007 forwarding=EG-1(#9)+EG-2(#20) story-level gates 唔阻 epic |
